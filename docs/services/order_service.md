...
- **Create order**
  ...
  | 2 | Consumer Service | ValidateOrderByConsumerCommand | | Ask the Consumer Service to validate the consumer of this order.<ul><li>Check the consumer of this order is existing in the Consumer Service. <li>Validate total amount of this order (*NOT IMPLEMENTED*)</ul> | 
